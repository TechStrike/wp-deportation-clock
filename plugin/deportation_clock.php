...
if (!defined( DC_OBAMA_PLUGINURL ))
	...
	define( DC_OBAMA_PLUGINURL, 'http://localhost/wp-content/plugins/deportation_clock' ); //var_dump( DC_W_PLUGINURL );

if (!defined( DC_OBAMA_PLUGINPATH ))
	define( DC_OBAMA_PLUGINPATH, plugin_dir_path(__FILE__)); //var_dump( DC_W_PLUGINPATH );
